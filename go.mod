...
replace github.com/sdcio/config-server => /home/mava/projects/config-server
...
require (
	...
	github.com/henderiw/apiserver-store v0.0.2 // indirect
	...
	github.com/sdcio/cache v0.0.35 // indirect
	github.com/sdcio/data-server v0.0.54 // indirect
	github.com/sdcio/schema-server v0.0.30 // indirect
